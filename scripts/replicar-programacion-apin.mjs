...
const COD_MODULO = 'APIN';       // código/abreviatura del módulo a buscar
const NOMBRE_GRUPO = 'SM1';      // nombre del grupo a buscar
...
const UNIDADES = [
  ...
  { n: 1,  titulo: 'UD1: Instalación de aplicaciones ofimáticas', ra: 'RA1: Instala y actualiza aplicaciones ofimáticas, interpretando especificaciones y describiendo los pasos a seguir en el proceso', horas: 6,  eval: EVAL_1 },
  { n: 2,  titulo: 'UD2: Elaboración de documentos y plantillas', ra: 'RA2: Elabora documentos y plantillas, describiendo y aplicando las opciones avanzadas de procesadores de textos', horas: 21, eval: EVAL_1 },
  { n: 3,  titulo: 'UD3: Elaboración de hojas de cálculo', ra: 'RA3: Elabora documentos y plantillas de cálculo, describiendo y aplicando opciones avanzadas de hojas de cálculo', horas: 28, eval: EVAL_1 },
  { n: 4,  titulo: 'UD4: Elaboración de presentaciones', ra: 'RA7: Elabora presentaciones multimedia describiendo y aplicando las normas básicas de composición y diseño', horas: 14, eval: EVAL_1 },
  { n: 5,  titulo: 'UD5: Gestión de correo y agenda electrónica', ra: 'RA8: Realiza operaciones de gestión del correo y la agenda electrónica, relacionando necesidades de uso con su configuración', horas: 7,  eval: EVAL_1 },
  { n: 6,  titulo: 'UD6: Diseño de una base de datos relacional', ra: 'RA4: Elabora documentos con bases de datos ofimáticas describiendo y aplicando operaciones de manipulación de datos', horas: 21, eval: EVAL_1 },
  { n: 7,  titulo: 'UD7: Definición y manipulación de bases de datos (I)', ra: 'RA4: Elabora documentos con bases de datos ofimáticas describiendo y aplicando operaciones de manipulación de datos', horas: 28, eval: EVAL_1 },
  { n: 8,  titulo: 'UD8: Definición y manipulación de bases de datos (II)', ra: 'RA4: Elabora documentos con bases de datos ofimáticas describiendo y aplicando operaciones de manipulación de datos', horas: 28, eval: EVAL_2 },
  { n: 9,  titulo: 'UD9: Manipulación básica de imágenes', ra: 'RA5: Manipula imágenes digitales analizando las posibilidades de distintos programas y aplicando técnicas de retoque', horas: 28, eval: EVAL_2 },
  { n: 10, titulo: 'UD10: Manipulación avanzada de imágenes', ra: 'RA5: Manipula imágenes digitales analizando las posibilidades de distintos programas y aplicando técnicas de retoque', horas: 21, eval: EVAL_2 },
  { n: 11, titulo: 'UD11: Manipulación de secuencias de vídeo', ra: 'RA6: Manipula secuencias de vídeo analizando las posibilidades de distintos programas y aplicando técnicas de captura y edición', horas: 28, eval: EVAL_2 },
];
...
const TAREAS = [
  { titulo: 'Práctica 1: Instalación y configuración de la suite ofimática', descripcion: 'Instalación, actualización y configuración de aplicaciones ofimáticas.', udRef: 1, eval: EVAL_1, peso: 5 },
  { titulo: 'Práctica 2: Documento con estilos, índices y plantillas', descripcion: 'Elaboración de un documento extenso con estilos, tablas, índices y plantillas en el procesador de textos.', udRef: 2, eval: EVAL_1, peso: 10 },
  { titulo: 'Práctica 3: Hoja de cálculo con fórmulas y gráficos', descripcion: 'Hoja de cálculo con funciones avanzadas, referencias, gráficos y formato condicional.', udRef: 3, eval: EVAL_1, peso: 10 },
  { titulo: 'Práctica 4: Presentación multimedia', descripcion: 'Diseño de una presentación con normas de composición, transiciones y elementos multimedia.', udRef: 4, eval: EVAL_1, peso: 10 },
  { titulo: 'Práctica 5: Gestión de correo y agenda', descripcion: 'Configuración de cuentas de correo, reglas, contactos y agenda electrónica.', udRef: 5, eval: EVAL_1, peso: 5 },
  { titulo: 'Práctica 6: Diseño de base de datos relacional', descripcion: 'Diseño del modelo entidad-relación y creación de tablas con sus relaciones.', udRef: 6, eval: EVAL_1, peso: 10 },
  { titulo: 'Práctica 7: Consultas, formularios e informes', descripcion: 'Manipulación de la base de datos con consultas, formularios e informes.', udRef: 8, eval: EVAL_2, peso: 15 },
  { titulo: 'Práctica 8: Retoque de imágenes digitales', descripcion: 'Manipulación básica y avanzada de imágenes: capas, máscaras y filtros.', udRef: 10, eval: EVAL_2, peso: 10 },
  { titulo: 'Proyecto final: Edición de secuencias de vídeo', descripcion: 'Captura y edición de un vídeo con transiciones, audio y exportación.', udRef: 11, eval: EVAL_2, peso: 15 },
];

// Exámenes: pruebas por evaluación (udRef = nº de UD tras la cual se realiza)
const EXAMENES = [
  { titulo: 'Examen 1ª Evaluación: Procesador de textos y hoja de cálculo', descripcion: 'Documentos, plantillas, hojas de cálculo con funciones y gráficos.', udRef: 3, eval: EVAL_1, tipo: 'parcial' },
  { titulo: 'Examen 1ª Evaluación: Presentaciones, correo y bases de datos', descripcion: 'Presentaciones multimedia, gestión de correo y diseño de bases de datos.', udRef: 7, eval: EVAL_1, tipo: 'parcial' },
  { titulo: 'Examen final: Bases de datos, imagen y vídeo', descripcion: 'Manipulación de bases de datos, imágenes digitales y secuencias de vídeo. Examen final del módulo.', udRef: 11, eval: EVAL_2, tipo: 'final', esFinal: true },
];
...
async function run() {
  console.log(`\n${'='.repeat(60)}`);
  console.log(`  REPLICAR PROGRAMACIÓN APIN · curso ${CURSO}`);
